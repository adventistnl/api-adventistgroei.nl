...
import { SubsidyActivityCount } from './subsidy-activity-count.output';

@ObjectType()
export class SubsidyActivity {
    ...
    @Field(() => SubsidyActivityCount, {nullable:false})
    _count?: SubsidyActivityCount;
}
