...
@InputType()
export class MissionProjectScalarWhereWithAggregatesInput {

    @Field(() => [MissionProjectScalarWhereWithAggregatesInput], {nullable:true})
    @Type(() => MissionProjectScalarWhereWithAggregatesInput)
    AND?: Array<MissionProjectScalarWhereWithAggregatesInput>;

    @Field(() => [MissionProjectScalarWhereWithAggregatesInput], {nullable:true})
    @Type(() => MissionProjectScalarWhereWithAggregatesInput)
    OR?: Array<MissionProjectScalarWhereWithAggregatesInput>;

    @Field(() => [MissionProjectScalarWhereWithAggregatesInput], {nullable:true})
    @Type(() => MissionProjectScalarWhereWithAggregatesInput)
    NOT?: Array<MissionProjectScalarWhereWithAggregatesInput>;
