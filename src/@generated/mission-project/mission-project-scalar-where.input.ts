...
@InputType()
export class MissionProjectScalarWhereInput {

    @Field(() => [MissionProjectScalarWhereInput], {nullable:true})
    @Type(() => MissionProjectScalarWhereInput)
    AND?: Array<MissionProjectScalarWhereInput>;

    @Field(() => [MissionProjectScalarWhereInput], {nullable:true})
    @Type(() => MissionProjectScalarWhereInput)
    OR?: Array<MissionProjectScalarWhereInput>;

    @Field(() => [MissionProjectScalarWhereInput], {nullable:true})
    @Type(() => MissionProjectScalarWhereInput)
    NOT?: Array<MissionProjectScalarWhereInput>;
