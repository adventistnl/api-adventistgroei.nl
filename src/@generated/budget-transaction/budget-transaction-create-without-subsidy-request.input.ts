...
import { AnnualBudgetCreateNestedOneWithoutTransactionsInput } from '../annual-budget/annual-budget-create-nested-one-without-transactions.input';
...
@InputType()
export class BudgetTransactionCreateWithoutSubsidy_requestInput {
    ...
    @Field(() => AnnualBudgetCreateNestedOneWithoutTransactionsInput, {nullable:false})
    @Type(() => AnnualBudgetCreateNestedOneWithoutTransactionsInput)
    annual_budget!: AnnualBudgetCreateNestedOneWithoutTransactionsInput;
