...
import { CommunicationOrderByWithRelationInput } from '../communication/communication-order-by-with-relation.input';

@InputType()
export class CommunicationRecipientOrderByWithRelationInput {
