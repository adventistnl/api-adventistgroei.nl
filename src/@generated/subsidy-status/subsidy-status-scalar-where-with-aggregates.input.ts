...
@InputType()
export class SubsidyStatusScalarWhereWithAggregatesInput {

    @Field(() => [SubsidyStatusScalarWhereWithAggregatesInput], {nullable:true})
    AND?: Array<SubsidyStatusScalarWhereWithAggregatesInput>;

    @Field(() => [SubsidyStatusScalarWhereWithAggregatesInput], {nullable:true})
    OR?: Array<SubsidyStatusScalarWhereWithAggregatesInput>;

    @Field(() => [SubsidyStatusScalarWhereWithAggregatesInput], {nullable:true})
    NOT?: Array<SubsidyStatusScalarWhereWithAggregatesInput>;
    ...
    @Field(() => StringWithAggregatesFilter, {nullable:true})
    assigned_to?: StringWithAggregatesFilter;
