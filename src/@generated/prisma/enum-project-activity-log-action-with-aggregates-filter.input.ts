...
import { NestedEnumProjectActivityLogActionWithAggregatesFilter } from './nested-enum-project-activity-log-action-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumProjectActivityLogActionFilter } from './nested-enum-project-activity-log-action-filter.input';

@InputType()
export class EnumProjectActivityLogActionWithAggregatesFilter {
