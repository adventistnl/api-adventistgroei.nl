...
import { NestedEnumAnnualBudgetStatusWithAggregatesFilter } from './nested-enum-annual-budget-status-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumAnnualBudgetStatusFilter } from './nested-enum-annual-budget-status-filter.input';

@InputType()
export class EnumAnnualBudgetStatusWithAggregatesFilter {
