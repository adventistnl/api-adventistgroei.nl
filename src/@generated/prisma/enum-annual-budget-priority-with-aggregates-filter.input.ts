...
import { NestedEnumAnnualBudgetPriorityWithAggregatesFilter } from './nested-enum-annual-budget-priority-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumAnnualBudgetPriorityFilter } from './nested-enum-annual-budget-priority-filter.input';

@InputType()
export class EnumAnnualBudgetPriorityWithAggregatesFilter {
