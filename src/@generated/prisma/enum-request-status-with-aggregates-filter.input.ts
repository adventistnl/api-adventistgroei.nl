...
import { NestedEnumRequestStatusWithAggregatesFilter } from './nested-enum-request-status-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumRequestStatusFilter } from './nested-enum-request-status-filter.input';

@InputType()
export class EnumRequestStatusWithAggregatesFilter {
