...
import { NestedEnumActivityStatusWithAggregatesFilter } from './nested-enum-activity-status-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumActivityStatusFilter } from './nested-enum-activity-status-filter.input';

@InputType()
export class EnumActivityStatusWithAggregatesFilter {
