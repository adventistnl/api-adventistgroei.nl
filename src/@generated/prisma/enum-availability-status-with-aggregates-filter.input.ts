...
import { NestedEnumAvailabilityStatusWithAggregatesFilter } from './nested-enum-availability-status-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumAvailabilityStatusFilter } from './nested-enum-availability-status-filter.input';

@InputType()
export class EnumAvailabilityStatusWithAggregatesFilter {
