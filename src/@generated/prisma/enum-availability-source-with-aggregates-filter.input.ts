...
import { NestedEnumAvailabilitySourceWithAggregatesFilter } from './nested-enum-availability-source-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumAvailabilitySourceFilter } from './nested-enum-availability-source-filter.input';

@InputType()
export class EnumAvailabilitySourceWithAggregatesFilter {
