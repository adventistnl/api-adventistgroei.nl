...
import { NestedEnumSubsidyRequestTypeWithAggregatesFilter } from './nested-enum-subsidy-request-type-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumSubsidyRequestTypeFilter } from './nested-enum-subsidy-request-type-filter.input';

@InputType()
export class EnumSubsidyRequestTypeWithAggregatesFilter {
