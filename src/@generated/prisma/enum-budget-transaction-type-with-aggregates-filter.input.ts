...
import { NestedEnumBudgetTransactionTypeWithAggregatesFilter } from './nested-enum-budget-transaction-type-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumBudgetTransactionTypeFilter } from './nested-enum-budget-transaction-type-filter.input';

@InputType()
export class EnumBudgetTransactionTypeWithAggregatesFilter {
