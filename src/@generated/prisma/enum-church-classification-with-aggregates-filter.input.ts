...
import { NestedEnumChurchClassificationWithAggregatesFilter } from './nested-enum-church-classification-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumChurchClassificationFilter } from './nested-enum-church-classification-filter.input';

@InputType()
export class EnumChurchClassificationWithAggregatesFilter {
