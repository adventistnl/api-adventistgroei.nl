...
import { InstitutionUpdateOneRequiredWithoutAvailabilitiesNestedInput } from '../institution/institution-update-one-required-without-availabilities-nested.input';
...
@InputType()
export class AvailabilityUpdateWithoutRecurrence_ruleInput {
    ...
    @Field(() => InstitutionUpdateOneRequiredWithoutAvailabilitiesNestedInput, {nullable:true})
    @Type(() => InstitutionUpdateOneRequiredWithoutAvailabilitiesNestedInput)
    institution?: InstitutionUpdateOneRequiredWithoutAvailabilitiesNestedInput;
