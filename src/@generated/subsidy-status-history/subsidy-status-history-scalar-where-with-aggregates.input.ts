...
import { EnumSubsidyHistoryTypeWithAggregatesFilter } from '../prisma/enum-subsidy-history-type-with-aggregates-filter.input';
...
export class SubsidyStatusHistoryScalarWhereWithAggregatesInput {
    ...
    @Field(() => EnumSubsidyHistoryTypeWithAggregatesFilter, {nullable:true})
    type?: EnumSubsidyHistoryTypeWithAggregatesFilter;
