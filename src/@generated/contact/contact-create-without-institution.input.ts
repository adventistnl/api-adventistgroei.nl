...
import { EventCreateNestedManyWithoutContactInput } from '../event/event-create-nested-many-without-contact.input';

@InputType()
export class ContactCreateWithoutInstitutionInput {
    ...
    @Field(() => EventCreateNestedManyWithoutContactInput, {nullable:true})
    @Type(() => EventCreateNestedManyWithoutContactInput)
    Event?: EventCreateNestedManyWithoutContactInput;
}
