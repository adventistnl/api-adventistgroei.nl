...
@InputType()
export class AssignmentInviteTemplateScalarWhereWithAggregatesInput {

    @Field(() => [AssignmentInviteTemplateScalarWhereWithAggregatesInput], {nullable:true})
    AND?: Array<AssignmentInviteTemplateScalarWhereWithAggregatesInput>;

    @Field(() => [AssignmentInviteTemplateScalarWhereWithAggregatesInput], {nullable:true})
    OR?: Array<AssignmentInviteTemplateScalarWhereWithAggregatesInput>;

    @Field(() => [AssignmentInviteTemplateScalarWhereWithAggregatesInput], {nullable:true})
    NOT?: Array<AssignmentInviteTemplateScalarWhereWithAggregatesInput>;
