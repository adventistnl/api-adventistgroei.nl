...
@InputType()
export class InstitutionPositionUpsertWithWhereUniqueWithoutUserInput {
    ...
    update!: InstitutionPositionUpdateWithoutUserInput;

    @Field(() => InstitutionPositionCreateWithoutUserInput, {nullable:false})
    @Type(() => InstitutionPositionCreateWithoutUserInput)
    create!: InstitutionPositionCreateWithoutUserInput;
}
