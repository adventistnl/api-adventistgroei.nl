...
import { InstitutionCreateNestedOneWithoutAssignment_requestsInput } from '../institution/institution-create-nested-one-without-assignment-requests.input';
...
@InputType()
export class AssignmentRequestCreateWithoutTemplateInput {
    ...
    @Field(() => InstitutionCreateNestedOneWithoutAssignment_requestsInput, {nullable:false})
    @Type(() => InstitutionCreateNestedOneWithoutAssignment_requestsInput)
    institution!: InstitutionCreateNestedOneWithoutAssignment_requestsInput;
