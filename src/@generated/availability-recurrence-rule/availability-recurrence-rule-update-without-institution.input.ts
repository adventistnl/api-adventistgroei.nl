...
import { AvailabilityUpdateManyWithoutRecurrence_ruleNestedInput } from '../availability/availability-update-many-without-recurrence-rule-nested.input';

@InputType()
export class AvailabilityRecurrenceRuleUpdateWithoutInstitutionInput {
    ...
    @Field(() => AvailabilityUpdateManyWithoutRecurrence_ruleNestedInput, {nullable:true})
    materialized_availabilities?: AvailabilityUpdateManyWithoutRecurrence_ruleNestedInput;
}
