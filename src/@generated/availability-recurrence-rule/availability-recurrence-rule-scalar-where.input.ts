...
@InputType()
export class AvailabilityRecurrenceRuleScalarWhereInput {

    @Field(() => [AvailabilityRecurrenceRuleScalarWhereInput], {nullable:true})
    AND?: Array<AvailabilityRecurrenceRuleScalarWhereInput>;

    @Field(() => [AvailabilityRecurrenceRuleScalarWhereInput], {nullable:true})
    OR?: Array<AvailabilityRecurrenceRuleScalarWhereInput>;

    @Field(() => [AvailabilityRecurrenceRuleScalarWhereInput], {nullable:true})
    NOT?: Array<AvailabilityRecurrenceRuleScalarWhereInput>;
