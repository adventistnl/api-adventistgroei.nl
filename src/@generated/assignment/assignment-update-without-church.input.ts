...
import { InstitutionUpdateOneRequiredWithoutAssignmentsNestedInput } from '../institution/institution-update-one-required-without-assignments-nested.input';
import { Type } from 'class-transformer';
import { UserUpdateOneWithoutAssignmentsNestedInput } from '../user/user-update-one-without-assignments-nested.input';

@InputType()
export class AssignmentUpdateWithoutChurchInput {
    ...
    @Field(() => InstitutionUpdateOneRequiredWithoutAssignmentsNestedInput, {nullable:true})
    @Type(() => InstitutionUpdateOneRequiredWithoutAssignmentsNestedInput)
