...
import { ChurchCreateNestedOneWithoutAssignmentsInput } from '../church/church-create-nested-one-without-assignments.input';
import { Type } from 'class-transformer';
import { UserCreateNestedOneWithoutAssignmentsInput } from '../user/user-create-nested-one-without-assignments.input';

@InputType()
export class AssignmentCreateWithoutInstitutionInput {
    ...
    @Field(() => ChurchCreateNestedOneWithoutAssignmentsInput, {nullable:false})
    @Type(() => ChurchCreateNestedOneWithoutAssignmentsInput)
    church!: ChurchCreateNestedOneWithoutAssignmentsInput;
