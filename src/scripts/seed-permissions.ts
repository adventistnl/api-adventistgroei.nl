...
const permissionsDisabledToClient = [
  { name: 'update user', description: 'Update a user', resolver_name: 'updateUser' as PermissionResolverName, group: 'USER' as PermissionGroup, key_code: 'USER_UPDATE', disabled_to_client: true },
  { name: 'delete user', description: 'Delete a user', resolver_name: 'deleteUser' as PermissionResolverName, group: 'USER' as PermissionGroup, key_code: 'USER_DELETE', disabled_to_client: true },
  { name: 'update institution', description: 'Update an institution', resolver_name: 'updateInstitution' as PermissionResolverName, group: 'INSTITUTION' as PermissionGroup, key_code: 'INSTITUTION_UPDATE', disabled_to_client: true },
  ...
  { name: 'update region', description: 'Update a region', resolver_name: 'updateRegion' as PermissionResolverName, group: 'REGION' as PermissionGroup, key_code: 'REGION_UPDATE', disabled_to_client: true },
  { name: 'delete region', description: 'Delete a region', resolver_name: 'deleteRegion' as PermissionResolverName, group: 'REGION' as PermissionGroup, key_code: 'REGION_DELETE', disabled_to_client: true },
  { name: 'update church', description: 'Update a church', resolver_name: 'updateChurch' as PermissionResolverName, group: 'CHURCH' as PermissionGroup, key_code: 'CHURCH_UPDATE', disabled_to_client: true },
  { name: 'delete church', description: 'Delete a church', resolver_name: 'deleteChurch' as PermissionResolverName, group: 'CHURCH' as PermissionGroup, key_code: 'CHURCH_DELETE', disabled_to_client: true },
  { name: 'update department', description: 'Update a department', resolver_name: 'updateDepartment' as PermissionResolverName, group: 'DEPARTMENT' as PermissionGroup, key_code: 'DEPARTMENT_UPDATE', disabled_to_client: true },
  { name: 'delete department', description: 'Delete a department', resolver_name: 'deleteDepartment' as PermissionResolverName, group: 'DEPARTMENT' as PermissionGroup, key_code: 'DEPARTMENT_DELETE', disabled_to_client: true },
  ...
  { name: 'create annual budget', description: 'Create an annual budget', resolver_name: 'createAnnualBudget' as PermissionResolverName, group: 'ANNUAL_BUDGET' as PermissionGroup, key_code: 'ANNUAL_BUDGET_CREATE', disabled_to_client: true },
  { name: 'read annual budgets', description: 'Access to annual budgets list', resolver_name: 'annualBudgets' as PermissionResolverName, group: 'ANNUAL_BUDGET' as PermissionGroup, key_code: 'ANNUAL_BUDGETS_ACCESS', disabled_to_client: true },
  { name: 'read annual budget', description: 'Access to a single annual budget', resolver_name: 'annualBudget' as PermissionResolverName, group: 'ANNUAL_BUDGET' as PermissionGroup, key_code: 'ANNUAL_BUDGET_ACCESS', disabled_to_client: true },
  { name: 'update annual budget', description: 'Update an annual budget', resolver_name: 'updateAnnualBudget' as PermissionResolverName, group: 'ANNUAL_BUDGET' as PermissionGroup, key_code: 'ANNUAL_BUDGET_UPDATE', disabled_to_client: true },
  { name: 'delete annual budget', description: 'Delete an annual budget', resolver_name: 'deleteAnnualBudget' as PermissionResolverName, group: 'ANNUAL_BUDGET' as PermissionGroup, key_code: 'ANNUAL_BUDGET_DELETE', disabled_to_client: true },
  { name: 'approve annual budget', description: 'Approve an annual budget', resolver_name: 'approveAnnualBudget' as PermissionResolverName, group: 'ANNUAL_BUDGET' as PermissionGroup, key_code: 'ANNUAL_BUDGET_APPROVE', disabled_to_client: true },
  { name: 'reject annual budget', description: 'Reject an annual budget', resolver_name: 'rejectAnnualBudget' as PermissionResolverName, group: 'ANNUAL_BUDGET' as PermissionGroup, key_code: 'ANNUAL_BUDGET_REJECT', disabled_to_client: true },
  { name: 'request revision annual budget', description: 'Request revision for an annual budget', resolver_name: 'requestRevisionAnnualBudget' as PermissionResolverName, group: 'ANNUAL_BUDGET' as PermissionGroup, key_code: 'ANNUAL_BUDGET_REQUEST_REVISION', disabled_to_client: true },
  { name: 'toggle budget lock', description: 'Toggle lock status of an annual budget', resolver_name: 'toggleBudgetLock' as PermissionResolverName, group: 'ANNUAL_BUDGET' as PermissionGroup, key_code: 'ANNUAL_BUDGET_TOGGLE_LOCK', disabled_to_client: true },
  { name: 'read budget KPIs', description: 'Access to budget KPIs', resolver_name: 'budgetKPIs' as PermissionResolverName, group: 'ANNUAL_BUDGET' as PermissionGroup, key_code: 'BUDGET_KPIS_ACCESS', disabled_to_client: true },
  { name: 'read department spending', description: 'Access to department spending data', resolver_name: 'departmentSpending' as PermissionResolverName, group: 'ANNUAL_BUDGET' as PermissionGroup, key_code: 'DEPARTMENT_SPENDING_ACCESS', disabled_to_client: true },
  { name: 'read spending over time', description: 'Access to spending over time data', resolver_name: 'spendingOverTime' as PermissionResolverName, group: 'ANNUAL_BUDGET' as PermissionGroup, key_code: 'SPENDING_OVER_TIME_ACCESS', disabled_to_client: true },
  { name: 'read entity distribution', description: 'Access to entity distribution data', resolver_name: 'entityDistribution' as PermissionResolverName, group: 'ANNUAL_BUDGET' as PermissionGroup, key_code: 'ENTITY_DISTRIBUTION_ACCESS', disabled_to_client: true },
  { name: 'read budget distribution', description: 'Access to budget distribution data', resolver_name: 'budgetDistribution' as PermissionResolverName, group: 'ANNUAL_BUDGET' as PermissionGroup, key_code: 'BUDGET_DISTRIBUTION_ACCESS', disabled_to_client: true },
];
...
const permissionsEnabledToClient = [
  ...
  { name: 'read communications', description: 'Access to communications', resolver_name: 'communications' as PermissionResolverName, group: 'COMMUNICATION' as PermissionGroup, key_code: 'COMMUNICATIONS_ACCESS', disabled_to_client: false },
  { name: 'read communication', description: 'Access to a single communication', resolver_name: 'communication' as PermissionResolverName, group: 'COMMUNICATION' as PermissionGroup, key_code: 'COMMUNICATION_ACCESS', disabled_to_client: false },
  { name: 'read direct messages', description: 'Access to direct messages', resolver_name: 'directMessages' as PermissionResolverName, group: 'DIRECT_MESSAGE' as PermissionGroup, key_code: 'DIRECT_MESSAGES_ACCESS', disabled_to_client: false },
  { name: 'read direct message', description: 'Access to a single direct message', resolver_name: 'directMessage' as PermissionResolverName, group: 'DIRECT_MESSAGE' as PermissionGroup, key_code: 'DIRECT_MESSAGE_ACCESS', disabled_to_client: false },
  ...
  { name: 'read notifications', description: 'Access to notifications', resolver_name: 'notifications' as PermissionResolverName, group: 'NOTIFICATION' as PermissionGroup, key_code: 'NOTIFICATIONS_ACCESS', disabled_to_client: false },
  { name: 'read notification', description: 'Access to a single notification', resolver_name: 'notification' as PermissionResolverName, group: 'NOTIFICATION' as PermissionGroup, key_code: 'NOTIFICATION_ACCESS', disabled_to_client: false },
  { name: 'read settings', description: 'Access to settings', resolver_name: 'settings' as PermissionResolverName, group: 'SETTING' as PermissionGroup, key_code: 'SETTINGS_ACCESS', disabled_to_client: false },
  { name: 'read setting', description: 'Access to a single setting', resolver_name: 'setting' as PermissionResolverName, group: 'SETTING' as PermissionGroup, key_code: 'SETTING_ACCESS', disabled_to_client: false },
