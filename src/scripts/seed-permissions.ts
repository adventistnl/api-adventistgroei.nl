...
const permissionsDisabledToClient = [
  ...
  { name: 'upload subsidy receipt', description: 'Upload receipt to subsidy request', resolver_name: 'uploadSubsidyReceipt' as PermissionResolverName, group: 'SUBSIDY_RECEIPT' as PermissionGroup, key_code: 'UPLOAD_SUBSIDY_RECEIPT', disabled_to_client: true },
  { name: 'download subsidy receipt', description: 'Download receipt from subsidy request', resolver_name: 'downloadSubsidyReceipt' as PermissionResolverName, group: 'SUBSIDY_RECEIPT' as PermissionGroup, key_code: 'DOWNLOAD_SUBSIDY_RECEIPT', disabled_to_client: true },
  { name: 'delete subsidy receipt', description: 'Delete receipt from subsidy request', resolver_name: 'deleteSubsidyReceipt' as PermissionResolverName, group: 'SUBSIDY_RECEIPT' as PermissionGroup, key_code: 'DELETE_SUBSIDY_RECEIPT', disabled_to_client: true },
  { name: 'validate subsidy receipt', description: 'Validate uploaded subsidy receipt', resolver_name: 'validateSubsidyReceipt' as PermissionResolverName, group: 'SUBSIDY_RECEIPT' as PermissionGroup, key_code: 'VALIDATE_SUBSIDY_RECEIPT', disabled_to_client: true },
  { name: 'get subsidy receipts', description: 'List all receipts of a subsidy request', resolver_name: 'getSubsidyReceipts' as PermissionResolverName, group: 'SUBSIDY_RECEIPT' as PermissionGroup, key_code: 'GET_SUBSIDY_RECEIPTS', disabled_to_client: true },
  ...
  { name: 'approve subsidy request', description: 'Approve a subsidy request', resolver_name: 'approveSubsidyRequest' as PermissionResolverName, group: 'SUBSIDY_REQUEST' as PermissionGroup, key_code: 'SUBSIDY_REQUEST_APPROVE', disabled_to_client: true },
  { name: 'reject subsidy request', description: 'Reject a subsidy request', resolver_name: 'rejectSubsidyRequest' as PermissionResolverName, group: 'SUBSIDY_REQUEST' as PermissionGroup, key_code: 'SUBSIDY_REQUEST_REJECT', disabled_to_client: true },
