...
export class ProjectActivityService {
  ...
  async create(input: CreateProjectActivityInput, userId: string): Promise<ProjectActivity> {
    try {
  ...
  async update(input: UpdateProjectActivityInput, userId: string): Promise<ProjectActivity> {
    try {
